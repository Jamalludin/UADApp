...
public class DosenKamis extends Fragment {
    public DosenKamis() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.dosen_kamis, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        AdapterKamis adapterKamis = new AdapterKamis(jadwals);
        RecyclerView recyclerView = (RecyclerView)getActivity().findViewById(R.id.carddsnkamis);
        ...
        recyclerView.setAdapter(adapterKamis);
    }

    class AdapterKamis extends RecyclerView.Adapter<AdapterKamis.ViewKamis>{

        List<Jadwal> isiDatanya;

        class ViewKamis extends RecyclerView.ViewHolder{

            TextView matakuliah,kelas,sks,jam,ruang;

            public ViewKamis(View itemView) {
                super(itemView);
        ...
        AdapterKamis(List<Jadwal> data){
            isiDatanya = data;
        }

        @Override
        public void onBindViewHolder(ViewKamis holder, int position) {
        ...
        @Override
        public ViewKamis onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).
                    inflate(R.layout.card_view_jadwal_dosennya, parent,false);
            ViewKamis vi = new ViewKamis(v);
            return vi;
        }
    }
}
